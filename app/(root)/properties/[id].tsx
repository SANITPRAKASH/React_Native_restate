    ...
    <View>
      ...
      >
        <View className="relative w-full" style={{ height: windowHeight / 2 }}>
          <Image
            source={{ uri: property?.image || "https://dummyimage.com/400x300/ccc/fff&text=No+Image" }}
            className="size-full"
            resizeMode="cover"
          />
        ...
        <View className="px-5 mt-7 flex gap-2">
          <Text className="text-2xl font-rubik-extrabold">{property?.name || "Property"}</Text>
            ...
            <View className="w-full border-t border-primary-200 pt-7 mt-5">
              ...
              <View className="flex flex-row items-center justify-between mt-4">
                <View className="flex flex-row items-center">
                  <Image
                    source={{ uri: agent.avatar || "https://dummyimage.com/100x100/ccc/fff&text=Agent" }}
            ...
            <View className="mt-7">
              ...
              <View className="flex flex-row flex-wrap mt-2 gap-5">
                {property.facilities.map((item: string, index: number) => {
                  ...
                  return (
                    <View key={index} className="flex-1 items-center min-w-16 max-w-20">
